...
const KeymapSection = ({ selectedKey }) => {
      ...
      <div className="grid grid-cols-1 lg:grid-cols-[300px_1fr] gap-6">
        ...
        <div>
          ...
          <div className="flex gap-2">
            <button className="flex-1 h-9 rounded-md border border-white/[0.06] bg-white/[0.02] text-slate-300 font-display text-[11px] uppercase tracking-[0.18em] hover:border-white/20">
              Default
            </button>
            <button className="flex-1 h-9 rounded-md border border-[var(--accent)]/50 bg-[var(--accent)]/15 text-[var(--accent)] font-display text-[11px] uppercase tracking-[0.18em] hover:bg-[var(--accent)]/25 shadow-[0_0_12px_var(--accent-glow)]">
              Apply
            </button>
          </div>
        </div>
    ...
    <div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-[320px_1fr] gap-6">
        ...
        <div className="rounded-xl border border-white/[0.06] bg-white/[0.02] p-4">
          ...
          <SwitchRender depth={travelTest ? (1.7 + Math.sin(Date.now()/600) * 1.2) : actuation} actuation={actuation}/>
        </div>
        ...
        <div className="rounded-xl border border-white/[0.06] bg-white/[0.02] p-5">
          ...
          {tab === "dead" && (
            <div>
              ...
              <div className="grid grid-cols-2 gap-6">
                <Slider label="Top Dead Band" value={0.04} min={0} max={0.5} step={0.01} unit="mm" onChange={() => {}}/>
                <Slider label="Bottom Dead Band" value={0.05} min={0} max={0.5} step={0.01} unit="mm" onChange={() => {}}/>
              </div>
            </div>
          )}
          ...
          {tab === "switch" && (
            <div>
              ...
              <div className="grid grid-cols-2 gap-3">
                {[
                  { id: "hm1",  name: "HM1", sub: "Magnetic Switch", dot: "#3b82f6", active: true },
          ...
          {tab === "calib" && (
            <div>
              ...
              <button className="px-5 h-10 rounded-md border border-[var(--accent)] bg-[var(--accent)] text-[var(--accent-fg)] font-display text-[12px] uppercase tracking-[0.18em] shadow-[0_0_18px_var(--accent-glow)] mb-5">
                Start Calibration
              </button>
...
/* ===== SOCD SECTION ===== */
const SOCDSection = ({ socdMode, setSocdMode, hotkey, hotkeyEnabled, setHotkeyEnabled }) => {
  const [profiles, setProfiles] = useState([
    { id: "SOCD1", k1: "A", k2: "D", mode: 1, active: true },
    { id: "SOCD2", k1: "W", k2: "S", mode: 1 },
  ]);
  const [active, setActive] = useState("SOCD1");
    ...
    <div>
      ...
      <div className="flex flex-wrap items-center gap-4 mb-5 pb-4 border-b border-white/[0.06]">
        ...
        <div className="ml-auto">
          <button className="px-5 h-9 rounded-md border border-[var(--accent)] bg-[var(--accent)] text-[var(--accent-fg)] font-display text-[12px] uppercase tracking-[0.16em] shadow-[0_0_18px_var(--accent-glow)] hover:brightness-110">
            Apply
          </button>
        </div>
      </div>
    ...
    <div>
      ...
      {tab === "about" && (
        <div className="rounded-xl border border-white/[0.06] bg-white/[0.02] p-5 max-w-xl">
          <div className="font-display text-[14px] text-slate-100 uppercase tracking-[0.18em]">Aether HE · Keyboard Hub</div>
...
window.AetherSections = {
  KeymapSection, ActuationSection, LightingSection, SOCDSection, OtherSection, ActuationToolbar
};
})();
