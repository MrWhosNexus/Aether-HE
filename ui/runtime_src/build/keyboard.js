(() => {
  ...
  /* FN-layer labels transcribed from the Aula Win60 HE box —
     "Magnetic Switch Keyboard · 30 Seconds Quick Operation Guide". */
  const KB_ROWS = [[["Esc", 4, "Escape", "`~"], ["1!", 4, "1", "F1"], ["2@", 4, "2", "F2"], ["3#", 4, "3", "F3"], ["$4", 4, "4", "F4"], ["5%", 4, "5", "F5"], ["6^", 4, "6", "F6"], ["7&", 4, "7", "F7"], ["8*", 4, "8", "F8"], ["9(", 4, "9", "F9"], ["0)", 4, "0", "F10"], ["-_", 4, "Minus", "F11"], ["=+", 4, "Equal", "F12"], ["Back", 8, "Backspace", "Color"]], [["Tab", 6, "Tab", "Light FX"], ["Q", 4, "Q", ""], ["W", 4, "W", "↑"], ["E", 4, "E", "Vol−"], ["R", 4, "R", "Vol+"], ["T", 4, "T", "Prev"], ["Y", 4, "Y", "Next"], ["U", 4, "U", "Play"], ["I", 4, "I", ""], ["O", 4, "O", "Mail"], ["P", 4, "P", "Home"], ["{[", 4, "Lbr", ""], ["}]", 4, "Rbr", ""], ["\\|", 6, "Bsl", ""]], [["Caps", 7, "Caps"], ["A", 4, "A", "←"], ["S", 4, "S", "↓"], ["D", 4, "D", "→"], ["F", 4, "F", "Brt+"], ["G", 4, "G", "Brt−"], ["H", 4, "H", ""], ["J", 4, "J", ""], ["K", 4, "K", ""], ["L", 4, "L", ""], [";:", 4, "Semi", "Ins"], ["'\"", 4, "Quot", ""], ["Enter", 9, "Enter", ""]], [["L-Shift", 9, "LShift"], ["Z", 4, "Z", "Win"], ["X", 4, "X", "Mac"], ["C", 4, "C", ""], ["V", 4, "V", ""], ["B", 4, "B", ""], ["N", 4, "N", "Reset"], ["M", 4, "M", "End"], [",<", 4, "Comma", "PgUp"], [".>", 4, "Dot", "PgDn"], ["/?", 4, "Slash", "Del"], ["R-Shift", 11, "RShift"]], [["L-Ctrl", 5, "LCtrl"], ["L-Win", 5, "LWin", "WinLk"], ["L-Alt", 5, "LAlt"], ["Space", 25, "Space"], ["R-Alt", 5, "RAlt"], ["Menu", 5, "Menu"], ["R-Ctrl", 5, "RCtrl"], ["Fn", 5, "Fn", "Fn"]]];
  ...
  const Key = React.memo(({
    ...
    if (mode === "lighting" && ledColor) {
      ...
      bg = lum < 6 ? "rgba(255,255,255,0.025)" : `linear-gradient(180deg, ${ledColor}, ${ledColor})`;
    }
    ...
    return /*#__PURE__*/React.createElement("button", {
      ...
      className: "text-[10px] text-[var(--text-dim)] font-medium"
    ...
    }, displayLabel)), mode === "actuation" && /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("span", {
      "aria-hidden": true,
      className: "absolute left-1 right-1 bottom-[3px] h-[3px] rounded-sm pointer-events-none z-0",
      style: {
      ...
      className: "absolute bottom-[7px] inset-x-1 z-10 flex items-end justify-between"
    }, /*#__PURE__*/React.createElement("span", {
      className: "font-mono text-[10px] font-semibold text-[var(--text)] leading-none"
  ...
  const KeyboardPanel = ({
    ...
    return /*#__PURE__*/React.createElement("div", {
      ...
      className: "font-mono text-[10px] uppercase tracking-[0.18em] text-[var(--text-faint)] whitespace-nowrap"
      ...
      className: "grid place-items-center w-7 h-7 rounded-full border border-[var(--line)] bg-white/[0.02] text-[var(--text-dim)] hover:text-[var(--text)] hover:border-[color-mix(in_srgb,var(--accent)_30%,transparent)] transition-colors",
