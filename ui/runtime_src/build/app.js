(() => {
  ...
  const TopBar = ({
    ...
    className: `relative inline-block w-1.5 h-1.5 rounded-full pulse-ring ${connected ? "bg-emerald-400 text-emerald-400" : "bg-[var(--text-faint)] text-[var(--text-faint)]"}`
  }), /*#__PURE__*/React.createElement("span", {
    className: "font-display text-[12.5px] tracking-[0.04em] text-[var(--text)]"
  }, "WIN 60 HE"), /*#__PURE__*/React.createElement("span", {
    className: `font-mono text-[9.5px] uppercase tracking-[0.2em] ml-1 ${connected ? "text-emerald-300/85" : "text-[var(--text-faint)]"}`
